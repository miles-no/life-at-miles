    ...
    const externalLinks = [
        {
            ...
            description: "Hold oversikt over tidligere lønnsslipper og se hva som venter på den neste utbetaling. 💰",
        },
        {
            title: "Logit",
        ...
        },
        {
            ...
            description: "Finn praktisk informasjon og ressurser for å støtte deg i arbeidslivet. 📚",
        },
        {
            title: "Slack",
            url: "http://miles-no.slack.com/",
            description: "Hold kontakten med teamet ditt og bli med i diskusjoner i våre Slack-kanaler. 💬",
        },
        {
            title: "Konferanser",
        ...
        },
        {
            ...
            description: "Se hvilke SMiles-arrangementer som skjer i nærmeste fremtid. 📅",
        },
        {
        ...
        },
        {
            ...
            description: "TFinn alle systemer, programvare, lisenser og andre verktøy du har standard tilgang til i Miles, samt de som administreres og finansieres av selskapet.👾",
        },
    ];
